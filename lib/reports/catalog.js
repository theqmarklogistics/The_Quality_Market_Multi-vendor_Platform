...
export const REPORTS = {
    sales: {
        ...
        description: 'Revenue, orders, average order value, top products and categories over time. Filter to a single store, category or product.',
    },
    payments: {
        type: 'payments',
        title: 'Payments',
    ...
    deliveries: {
        ...
        icon: 'Truck',
        description: 'Shipments by type and status, corridors, rider activity and delivery fees collected. Filter to a single rider, corridor, hub or package.',
    },
    riders: {
        type: 'riders',
