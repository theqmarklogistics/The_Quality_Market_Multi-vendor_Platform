...
async function ridersReport(scope, from, to) {
    ...
    const schedules = await prisma.corridorSchedule.findMany({ where: { isActive: true, riderId: { not: null } }, select: { riderId: true, dayOfWeek: true, corridorRouteId: true } });
