...
// WebSocket constructor — only needed for the Pool used by interactive transactions.
...
// @prisma/adapter-neon v7.x: PrismaNeonHttp takes a connection string directly,
// NOT a pre-built neon() SQL function. It calls neon(url) internally on connect().
// Preferred for Vercel serverless:
...
const httpAdapter = new PrismaNeonHttp(cleanUrl);
