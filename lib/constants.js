...
// Internal staff roles who can be recorded as having received a package at
// intake (the "Received by" dropdown on external deliveries). Everyone here is
// company staff — customers, sellers and external partners are excluded.
export const STAFF_RECEIVER_ROLES = [
    'ADMIN',
    'LOGISTICS_MANAGER',
    'WAREHOUSE_KEEPER',
...
// re-keyed to the official NISR sector names (see rwanda-geo-structure).
...
// Kigali districts and their official sectors (NISR administrative divisions).
